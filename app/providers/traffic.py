...
from app.providers.tomtom_parser import parse_flow_for_display
...
class TrafficProvider:
    ...
    def _parse_flow_response(self, data: Dict) -> List[Dict[str, Any]]:
        """
        Parse TomTom flow response into standardised format.

        Delegates to tomtom_parser.parse_flow_for_display() — single
        source of truth for all TomTom flow parsing.
        """
        return parse_flow_for_display(data)
